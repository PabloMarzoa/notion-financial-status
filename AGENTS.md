...
- **Pre-Commit Rule**: Before making any git commit or finishing code features, run `pnpm run test:coverage` and verify that all tests pass with at least **80% code coverage**.
